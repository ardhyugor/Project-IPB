...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <div class="mb-12 animate-on-scroll">
    <p class="text-sm font-semibold text-blue-600 mb-2">KEBIJAKAN & PRIVASI</p>
    <h2 class="text-4xl font-bold text-gray-900 mb-4">Kebijakan Privasi</h2>
    <p class="text-lg text-gray-600 mb-2">Layanan Arsip Digital - Komitmen Kami Terhadap Keamanan Data Anda</p>
    <p class="text-sm text-gray-500">Terakhir diperbarui: 21 November 2025</p>
  </div>
  ...
  <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12 shadow-sm animate-on-scroll delay-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
      <a href="#intro" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
      ...
      <a href="#collection" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5.951-1.429 5.951 1.429a1 1 0 001.169-1.409l-7-14z" /></svg>
        Pengumpulan Data
      </a>
      <a href="#usage" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5.951-1.429 5.951 1.429a1 1 0 001.169-1.409l-7-14z" /></svg>
        Penggunaan Data
      </a>
      <a href="#security" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5.951-1.429 5.951 1.429a1 1 0 001.169-1.409l-7-14z" /></svg>
        Keamanan Data
      </a>
      <a href="#rights" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5.951-1.429 5.951 1.429a1 1 0 001.169-1.409l-7-14z" /></svg>
        Hak-Hak Pengguna
      </a>
      <a href="#contact" class="text-blue-600 hover:text-blue-900 font-medium text-sm flex items-center gap-2 transition">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5.951-1.429 5.951 1.429a1 1 0 001.169-1.409l-7-14z" /></svg>
        Hubungi Kami
      </a>
    </div>
  ...
  <div class="space-y-8">
    ...
    <section id="intro" class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-2">
      ...
      <p class="text-gray-700 leading-relaxed">
        Kami berkomitmen untuk melindungi privasi Anda dalam menggunakan Layanan Arsip Digital. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, menyimpan, dan melindungi informasi pribadi Anda. Dengan menggunakan layanan kami, Anda menyetujui praktik-praktik yang dijelaskan dalam kebijakan ini.
      </p>
    </section>

    <!-- Section 2: Pengumpulan Data -->
    <section id="collection" class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-3">
    ...
    <section id="usage" class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-4">
      ...
      <ul class="space-y-3">
        <li class="flex items-start gap-3">
          ...
          <span class="text-gray-700"><strong class="text-gray-900">Verifikasi Pengguna:</strong> Memastikan identitas dan otorisasi akses ke sistem</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-blue-600 font-bold mt-1">✓</span>
          <span class="text-gray-700"><strong class="text-gray-900">Pelayanan:</strong> Memproses permintaan arsip dan memberikan dukungan teknis</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-blue-600 font-bold mt-1">✓</span>
          <span class="text-gray-700"><strong class="text-gray-900">Audit & Compliance:</strong> Memenuhi kepatuhan hukum dan regulasi pemerintah</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-blue-600 font-bold mt-1">✓</span>
          <span class="text-gray-700"><strong class="text-gray-900">Perbaikan Sistem:</strong> Menganalisis penggunaan untuk meningkatkan layanan</span>
        </li>
        <li class="flex items-start gap-3">
          <span class="text-blue-600 font-bold mt-1">✓</span>
          <span class="text-gray-700"><strong class="text-gray-900">Komunikasi:</strong> Mengirim notifikasi penting dan update layanan</span>
        </li>
      </ul>
    </section>
    ...
    <section id="security" class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-5">
      ...
      <div class="bg-blue-50 border border-blue-300 rounded-lg p-4">
        <p class="text-gray-700">
          <strong class="text-blue-900">Catatan:</strong> Meskipun kami telah menerapkan keamanan terbaik, tidak ada sistem yang sepenuhnya aman. Kami akan segera menginformasikan jika terjadi pelanggaran data.
        </p>
      </div>
    </section>
      ...
      <div class="space-y-4">
        ...
        <div class="flex gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200 animate-on-scroll delay-2">
          ...
          <div>
            ...
            <p class="text-gray-700 text-sm">Anda dapat meminta perbaikan data yang tidak akurat atau tidak lengkap</p>
          </div>
        </div>
        ...
        <div class="flex gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200 animate-on-scroll delay-4">
          ...
          <div>
            ...
            <p class="text-gray-700 text-sm">Anda dapat keberatan terhadap penggunaan data untuk keperluan tertentu</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Section 6: Kontak -->
    <section id="contact" class="bg-blue-50 border border-blue-300 rounded-lg p-8 shadow-sm animate-on-scroll delay-1">
      <h3 class="text-2xl font-bold text-gray-900 mb-6">Hubungi Kami</h3>
      <p class="text-gray-700 mb-6">Jika Anda memiliki pertanyaan tentang Kebijakan Privasi ini atau ingin menggunakan hak-hak Anda, silakan hubungi kami:</p>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white p-4 rounded-lg border border-blue-200 animate-on-scroll delay-1">
          ...
          <a href="mailto:privacy@arsip.go.id" class="text-blue-900 hover:text-blue-600 font-semibold transition">privacy@dsdmarsip.com</a>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg border border-blue-200 animate-on-scroll delay-3">
          ...
          <p class="text-gray-900 font-semibold">Gedung Rektorat Andi Hakim Nasoetion (AHN) Lt.4, Kampus Dramaga, Bogor 16680. </p>
        </div>
      </div>
    </section>
