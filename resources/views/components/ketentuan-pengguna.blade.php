...
<head>
  ...
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=gavel" />
  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-12 animate-on-scroll">
      ...
      <h2 class="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center">
        <span class="material-symbols-outlined">
          gavel
        </span>Ketentuan Pengguna
      </h2>
      <p class="text-lg text-gray-600 mb-2 flex items-center justify-center">Perjanjian Penggunaan Layanan Arsip Digital
      </p>
      <p class="text-sm text-gray-500 flex items-center justify-center">Berlaku sejak: 1 Januari 2025</p>
    </div>
    ...
    <div class="bg-amber-50 border-l-4 border-amber-500 rounded-lg p-6 mb-12 shadow-sm animate-on-scroll delay-1">
      <p class="text-gray-800 flex items-start gap-3">
        ...
        <span><strong class="text-gray-900">Penting:</strong> Dengan mengakses dan menggunakan Layanan Arsip Digital,
          Anda secara otomatis menyetujui semua ketentuan di bawah ini. Jika Anda tidak setuju, harap hentikan
          penggunaan layanan ini.</span>
      </p>
    </div>
    ...
    <div class="space-y-8">
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-2">
        ...
        <div class="space-y-4">
          <div class="pb-4 border-b border-gray-200 last:border-0 animate-on-scroll delay-1">
            ...
            <p class="text-gray-700">Platform digital untuk penyimpanan, pengorganisasian, dan penelusuran dokumen arsip
              yang disediakan oleh institusi pemerintah</p>
          </div>
          <div class="pb-4 border-b border-gray-200 last:border-0 animate-on-scroll delay-2">
            ...
            <p class="text-gray-700">Setiap individu yang telah terdaftar dan memiliki akun aktif untuk menggunakan
              Layanan Arsip Digital</p>
          </div>
          <div class="pb-4 border-b border-gray-200 last:border-0 animate-on-scroll delay-3">
            ...
            <p class="text-gray-700">Berkas atau file dalam berbagai format (PDF, Word, Excel, dsb) yang disimpan dalam
              sistem</p>
          </div>
          <div class="animate-on-scroll delay-4">
            <p class="font-semibold text-gray-900 mb-2">Akses</p>
            <p class="text-gray-700">Kemampuan untuk melihat, mengunduh, atau melakukan operasi lainnya terhadap dokumen
            </p>
          </div>
        </div>
      </section>
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-3">
        ...
        <div class="space-y-6">
          ...
          <div class="border-l-4 border-blue-600 pl-4 animate-on-scroll delay-2">
            ...
            <p class="text-gray-700 text-sm">Anda bertanggung jawab untuk menjaga kerahasiaan password dan akun Anda.
              Segera laporkan jika terjadi akses tidak sah atau penggunaan akun yang mencurigakan.</p>
          </div>
          <div class="border-l-4 border-blue-600 pl-4 animate-on-scroll delay-3">
            ...
            <p class="text-gray-700 text-sm">Kami berhak menangguhkan atau menghapus akun yang melanggar ketentuan tanpa
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-5">
        ...
        <div class="space-y-4 text-gray-700">
          <p class="animate-on-scroll delay-1"><strong class="text-gray-900">4.1 Hak Institusi:</strong> Semua konten,
            desain, dan fungsionalitas Layanan Arsip Digital adalah milik institusi dan dilindungi oleh hukum hak cipta.
          </p>
          <p class="animate-on-scroll delay-2"><strong class="text-gray-900">4.2 Hak Pengguna:</strong> Anda
            mempertahankan hak cipta atas dokumen yang Anda upload, namun memberikan lisensi kepada institusi untuk
            menyimpan, mengelola, dan memberikan akses kepada pengguna yang berwenang.</p>
          <p class="animate-on-scroll delay-3"><strong class="text-gray-900">4.3 Larangan Reproduksi:</strong> Anda
            tidak diperbolehkan mereproduksi, mendistribusikan, atau menggunakan konten layanan tanpa izin tertulis dari
            institusi.</p>
        </div>
      </section>
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-6">
        ...
        <div class="space-y-4">
          <div class="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-600 animate-on-scroll delay-1">
            ...
            <p class="text-gray-700 text-sm">Layanan disediakan "sebagaimana adanya" tanpa jaminan. Institusi tidak
              bertanggung jawab atas kerusakan, kehilangan data, atau gangguan layanan yang tidak terduga.</p>
          </div>
          <div class="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-600 animate-on-scroll delay-2">
            ...
            <p class="text-gray-700 text-sm">Kami berusaha menjaga uptime layanan 99.5%, namun tidak menjamin
              ketersediaan 24/7. Pemeliharaan rutin dapat menyebabkan downtime.</p>
          </div>
          <div class="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-600 animate-on-scroll delay-3">
            ...
            <p class="text-gray-700 text-sm">Institusi tidak bertanggung jawab atas kerugian tidak langsung, kehilangan
              data, atau biaya yang timbul dari penggunaan layanan ini.</p>
          </div>
        </div>
      </section>
      ...
      <section class="bg-white border border-gray-200 rounded-lg p-8 shadow-sm animate-on-scroll delay-7">
        ...
        <div class="space-y-4 text-gray-700">
          <p class="animate-on-scroll delay-1"><strong class="text-gray-900">6.1 Modifikasi Layanan:</strong> Kami
            berhak mengubah, menambah, atau mengurangi fitur layanan kapan saja dengan atau tanpa pemberitahuan.</p>
          <p class="animate-on-scroll delay-2"><strong class="text-gray-900">6.2 Penutupan:</strong> Institusi dapat
            menutup layanan ini dengan pemberitahuan minimal 30 hari sebelumnya.</p>
          <p class="animate-on-scroll delay-3"><strong class="text-gray-900">6.3 Backup Data:</strong> Pengguna
            direkomendasikan untuk membuat backup data mereka secara berkala.</p>
        </div>
      </section>
      ...
      <section class="bg-blue-50 border border-blue-300 rounded-lg p-8 shadow-sm animate-on-scroll delay-1">
        ...
        <p class="text-gray-700 mb-6">Jika Anda memiliki pertanyaan tentang Ketentuan Pengguna ini atau memerlukan
          bantuan teknis:</p>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-white p-5 rounded-lg border border-blue-200 animate-on-scroll delay-1">
            ...
            <a href="mailto:support@arsip.go.id"
              class="text-blue-600 hover:text-blue-900 font-semibold block mb-3 transition">support@arsip.go.id</a>
            <a href="mailto:legal@arsip.go.id"
              class="text-blue-600 hover:text-blue-900 font-semibold transition">legal@arsip.go.id</a>
          </div>
          <div class="bg-white p-5 rounded-lg border border-blue-200 animate-on-scroll delay-2">
            ...
            <p class="text-gray-700 text-sm">Jl. Arsip No. 123, Jakarta<br />Jam Layanan: Senin-Jumat, 08:00-16:00 WIB
            </p>
          </div>
        </div>
      </section>
